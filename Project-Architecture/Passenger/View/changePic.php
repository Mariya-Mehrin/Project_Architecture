...
<html>
    ...
    <body>
        <div class="container">
              <button type="button" id="b" onclick="window.location.href='dashBoard.php'">
    Back
</button><br>
     ...
     ?>
        <img  id="image" name="image" src="<?php echo    $imageDefault ?> "  style="height:200px;width:200px;border-radius:50%;display:center" >
<input type="file" id="link" name="link" placeholder="Enter image link"><br><br>
<button type="submit" onclick="changePic()">Update</button>
